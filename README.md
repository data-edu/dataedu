...
[![Last-changedate](https://img.shields.io/badge/last%20change-2020--03--04-yellowgreen.svg)](https://github.com/data-edu/dataedu/commits/master)
<!-- badges: end -->
...
ggplot(midwest, aes(x = area, y = popdensity, color = state)) +
  ...
  theme_dataedu() +
  scale_color_dataedu()
#> Warning in grepl("^FamilyName", text): input string 4 is invalid in this locale
#> Warning in grepl("^FontName", text): input string 4 is invalid in this locale
#> Warning in grepl("^FullName", text): input string 4 is invalid in this locale
