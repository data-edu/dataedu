...
#   read_csv(here(
#     "data-raw", 
#     "wt01_online_science_motivation",
#     "raw",
#     "s12-course-data.csv"
#   ))
#
...
course_data <- read_csv(here::here("data-raw", "wt01_online_science_motivation", "processed", "s12-course-data.csv"))
usethis::use_data(course_data, overwrite = TRUE)

# s12_pre_survey <-
#   read_csv(here(
#     "data-raw", "wt01_online_science_motivation",
#     "raw",
#     "s12-pre-survey.csv"
#   ))
#
...
pre_survey <- read_csv(here::here("data-raw", "wt01_online_science_motivation", "processed", "s12-pre-survey.csv"))
...
course_minutes <- read_csv(here::here("data-raw", "wt01_online_science_motivation", "processed", "s12-course-minutes.csv"))
usethis::use_data(course_minutes, overwrite = TRUE)

sci_mo_processed <- read_csv(here::here("data-raw", "wt01_online_science_motivation", "processed", "sci_mo_processed.csv"))
