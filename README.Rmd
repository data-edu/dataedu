...
[![Codecov test coverage](https://codecov.io/gh/ivelasq/dataedu/branch/master/graph/badge.svg)](https://codecov.io/gh/ivelasq/dataedu?branch=master)
<!-- badges: end -->
...
```{r, fig.align = "center", dpi = 300, message = FALSE}
library(ggplot2)
library(dataedu)
