...
The goal of dataedu is to provide readers of [Data Science in Education Using R](https://www.datascienceineducation.com/) with a package with useful functions, data, and references from the book.
